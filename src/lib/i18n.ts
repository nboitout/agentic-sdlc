...
export const copy: Record<LanguageCode, SiteCopy> = {
  en: {
    ...
    beyond: {
      eyebrow: 'Beyond Time & Materials',
      heading: 'Beyond Time & Materials',
      lead: 'Staffing sold time. The next model sells execution bursts.',
      paragraphs: [
      ...
      closing: 'Projects used to consume billable days. Now they consume execution bursts.',
    },
    core: {
      eyebrow: 'Core shift',
  ...
  fr: {
    ...
    beyond: {
      eyebrow: 'Au-delà du Time & Materials',
      heading: 'Au-delà du Time & Materials',
      lead: 'Le staffing vendait du temps. Le prochain modèle vend des capacités d’exécution.',
      paragraphs: [
        'Le renfort d’équipe classique a été conçu pour un monde où l’exécution était rare et où les projets duraient des années. On staffait des équipes, on vendait des jours facturables, et on augmentait l’activité avec plus de têtes.',
        'Avec les coding agents, la productivité augmente, les cycles de delivery se compressent, et le parallélisme progresse. Les clients peuvent absorber davantage d’exécution en interne, ce qui signifie que les personnes ne sont plus affectées aux projets de manière aussi statique.',
        'Les équipes externes ne disparaissent pas. Mais elles cessent d’être des engagements de staffing longs. Elles deviennent des bursts d’exécution courts et ciblés.',
      ],
      before: 'Avant',
      ...
      exampleRightValue: '3 flux d’exécution pendant 4 à 6 semaines',
      clientsEyebrow: 'Ce qui change pour les clients',
      clientsTitle: 'La décision n’est plus de savoir combien de personnes staffer pendant combien de mois.',
      bullets: [
        'Quelle quantité d’exécution devons-nous injecter maintenant ?',
        'Quelles initiatives méritent des bursts courts d’accélération ?',
        'Où avons-nous besoin de flux parallèles plutôt que de plus de jours facturables ?',
        'Quand la capacité doit-elle monter, s’arrêter, puis redémarrer ?',
      ],
      cards: [
        { title: 'Divisible', text: 'L’exécution se découpe en flux ciblés : migration, tests, refactoring.', num: '01' },
        { title: 'Compressée dans le temps', text: 'Le travail se livre en semaines, pas dans des cycles de staffing pluriannuels.', num: '02' },
        { title: 'Élastique', text: 'Monter en charge vite, s’arrêter proprement, redémarrer quand les priorités changent.', num: '03' },
        { title: 'Planifiable', text: 'L’exécution est routée selon les priorités, pas affectée statiquement à des équipes.', num: '04' },
      ],
      closing: 'Les projets consommaient autrefois des jours facturables. Ils consomment désormais des bursts d’exécution.',
    },
    core: {
      eyebrow: 'Changement de rôle central',
      heading: 'Évolution centrale du rôle du développeur.',
      body: 'À mesure que les coding agents prennent en charge davantage de travail, les développeurs ne disparaissent pas. Leur rôle change. Le nouvel enjeu est la supervision : quoi déléguer, quoi revoir, quoi valider, et quoi ne pas automatiser aveuglément.',
      cards: [
        { icon: 'hub', title: 'Ce qu’il faut déléguer', text: 'Décider où les coding agents peuvent aller vite sans créer de dette opérationnelle cachée.' },
        { icon: 'fact_check', title: 'Ce qu’il faut revoir', text: 'Rendre la supervision explicite pour que validation, approbation et escalade soient intégrées au workflow.' },
        { icon: 'shield_person', title: 'Ce qu’il ne faut pas automatiser aveuglément', text: 'Protéger la qualité, la responsabilité et la confiance client là où le jugement humain reste le plus important.' },
      ],
    },
    metrics: {
      eyebrow: 'Métriques',
    ...
    audience: {
      eyebrow: 'Pour qui',
      heading: 'Conçu pour les équipes qui ont besoin de la vitesse de l’IA avec une vraie responsabilité de delivery.',
      body: 'Cette mission s’adresse aux organisations qui expérimentent déjà des outils de code IA et qui cherchent maintenant un modèle opérationnel durable.',
      cards: [
        { icon: 'apartment', title: 'Leaders engineering', text: 'Des équipes qui passent d’un usage ad hoc de l’IA à un delivery gouverné avec des résultats mesurables.' },
        { icon: 'terminal', title: 'Équipes produit & plateforme', text: 'Des organisations qui standardisent des workflows assistés par IA sur la planification, la construction, la revue et la mise en production.' },
        { icon: 'handshake', title: 'Cabinets de conseil et sociétés de services', text: 'Des équipes de delivery qui ont besoin de gains de vitesse sans sacrifier la supervision, la qualité ou la responsabilité.' },
      ],
    },
    blueprint: {
      eyebrow: 'Blueprint',
      ...
      paragraphs: [
        'Acheter des licences et déployer des assistants de code ne dit pas à une entreprise comment délivrer autrement. Le véritable enjeu est de transformer la hausse de productivité et la compression du temps en un nouveau modèle opérationnel.',
        'À mesure que les cycles de delivery se raccourcissent, l’allocation des personnes devient plus dynamique. La question n’est plus : qui reste sur un projet pendant 18 mois ? Elle devient : quel système d’exécution sommes-nous réellement en train de construire ?',
      ],
      levelsLabel: 'Trois niveaux',
      levels: [
        { title: 'Agentic SDLC', text: 'Comment le delivery logiciel change' },
        { title: 'Agentic engineering', text: 'Comment les ingénieurs travaillent dans ce modèle' },
        { title: 'Harness engineering', text: 'Comment rendre les agents suffisamment fiables pour participer' },
      ],
      cards: [
        { title: 'Ground truth first', text: 'Distinguer l’adoption réelle de la culture de démonstration, du prompting isolé et du théâtre IA.' },
        { title: 'Prioriser les goulots d’étranglement', text: 'Se concentrer là où les workflows agentiques éliminent l’attente, les handoffs et les retouches.' },
        { title: 'Redéfinir la supervision', text: 'Clarifier ce que les agents peuvent faire seuls, ce qui doit être revu, et où commence l’escalade.' },
        { title: 'Instrumenter le système', text: 'Mesurer la contribution de l’IA, le throughput, les retouches, la qualité et la couverture de supervision.' },
        { title: 'Lancer le prochain modèle opérationnel', text: 'Transformer le blueprint en sprint concret, en pilote, ou en trajectoire de transformation du delivery.' },
      ],
    },
    engagement: {
      eyebrow: 'Mission',
      heading: 'Un sprint pour définir le modèle opérationnel.',
      body: 'Dans un sprint de travail focalisé, nous alignons leadership et ingénierie autour d’une prochaine étape pratique, avec des priorités, une gouvernance et des métriques claires.',
      quote: 'Une mission focalisée pour établir la réalité du terrain, les priorités et les règles de fonctionnement qui rendent la supervision de l’IA réellement opérationnelle.',
    },
    contact: {
  ...
  de: {
    ...
    beyond: {
      eyebrow: 'Jenseits von Time & Materials',
  ...
  es: {
    ...
    beyond: {
      eyebrow: 'Más allá de Time & Materials',
  ...
  ru: {
    ...
    beyond: {
      eyebrow: 'За пределами Time & Materials',
