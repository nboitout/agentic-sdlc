...
export const copy = {
  en: {
    ...
    beyond: {
      ...
      heading: 'Bench Management becomes critical',
  ...
  fr: {
    ...
    beyond: {
      ...
      heading: 'La gestion du bench devient critique',
  ...
  de: {
    ...
    beyond: {
      ...
      heading: 'Bench-Management wird zum Erfolgsfaktor',
  ...
  bg: {
    ...
    beyond: {
      ...
      heading: 'Управлението на bench-а става критично',
  ...
  pl: {
    ...
    beyond: {
      ...
      heading: 'Zarządzanie benchem staje się kluczowe',
  ...
  uk: {
    ...
    beyond: {
      ...
      heading: 'Управління bench-ресурсами стає критичним',
  ...
  es: {
    ...
    beyond: {
      ...
      heading: 'La gestión del bench se vuelve crítica',
  ...
  ru: {
    ...
    beyond: {
      ...
      heading: 'Управление скамейкой становится критичным',
...
Object.assign(copy, {
  it: mergeCopy(copy.en, {
    ...
    beyond: {
      ...
      heading: 'La gestione del bench diventa critica',
  ...
  nl: mergeCopy(copy.en, {
    ...
    beyond: { eyebrow: 'Voorbij Time & Materials', heading: 'Bench management wordt cruciaal', lead: 'Staffing verkocht tijd. Het volgende model verkoopt uitvoeringsbursts.', before: 'Vroeger', beforeValue: 'mensen × tijd', beforeCaption: 'factureerbare dagen · stabiele staffing · lange projecten', now: 'Nu', nowValue: 'uitvoeringsbursts', nowCaption: 'parallelle stromen · korte cycli · dynamische allocatie', clientsEyebrow: 'Wat verandert voor klanten', clientsTitle: 'De beslissing is niet langer hoeveel mensen voor hoeveel maanden.', closing: 'Projecten verbruikten factureerbare dagen. Nu verbruiken ze uitvoeringsbursts.' },
  ...
  da: mergeCopy(copy.en, {
    ...
    beyond: { eyebrow: 'Ud over Time & Materials', heading: 'Bench-styring bliver afgørende', lead: 'Staffing solgte tid. Den næste model sælger eksekveringsbursts.', before: 'Før', beforeValue: 'mennesker × tid', beforeCaption: 'fakturerbare dage · stabil staffing · lange projekter', now: 'Nu', nowValue: 'eksekveringsbursts', nowCaption: 'parallelle strømme · korte cyklusser · dynamisk allokering', clientsEyebrow: 'Hvad ændrer sig for kunder', clientsTitle: 'Beslutningen handler ikke længere om hvor mange mennesker i hvor mange måneder.', closing: 'Projekter brugte før fakturerbare dage. Nu bruger de eksekveringsbursts.' },
  ...
  sr: mergeCopy(copy.en, {
    ...
    beyond: { eyebrow: 'Изван Time & Materials', heading: 'Управљање бенчем постаје критично', lead: 'Staffing је продавао време. Следећи модел продаје burst-ове изведбе.', before: 'Раније', beforeValue: 'људи × време', beforeCaption: 'наплативи дани · стабилан staffing · дуги пројекти', now: 'Сада', nowValue: 'burst-ови изведбе', nowCaption: 'паралелни токови · кратки циклуси · динамичка алокација', clientsEyebrow: 'Шта се мења за клијенте', clientsTitle: 'Одлука више није колико људи ангажовати и на колико месеци.', closing: 'Пројекти су некад трошили наплативе дане. Сада троше burst-ове изведбе.' },
  ...
  tr: mergeCopy(copy.en, {
    ...
    beyond: { eyebrow: 'Time & Materials ötesi', heading: 'Bench yönetimi kritik hale geliyor', lead: 'Staffing zaman satıyordu. Yeni model yürütme burstleri satar.', before: 'Önce', beforeValue: 'insan × zaman', beforeCaption: 'faturalandırılabilir günler · stabil staffing · uzun projeler', now: 'Şimdi', nowValue: 'yürütme burstleri', nowCaption: 'paralel akışlar · kısa döngüler · dinamik tahsis', clientsEyebrow: 'Müşteriler için ne değişiyor', clientsTitle: 'Karar artık kaç kişiyi kaç ay görevlendirmek değil.', closing: 'Projeler eskiden faturalandırılabilir günler tüketirdi. Şimdi yürütme burstleri tüketiyor.' },
